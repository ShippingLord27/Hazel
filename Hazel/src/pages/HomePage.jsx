...
const popularProducts = useMemo(() => {
    ...
    const filtered = activeFilter === 'all' 
        // FIX: Filter by tag instead of category
        ? visibleProducts
        : visibleProducts.filter(p => p.tags && p.tags.includes(activeFilter));
    return filtered.slice(0, 6);
}, [products, activeFilter, currentUser]);

// Use a selection of popular tags for the homepage filter
